<div class="twelve columns alpha">
    ...
    <p>Control de los recursos dedicados a la labor de promoción, permitirá proporcionar datos claros y objetivos, la organización por región (país, estado, ciudad), los investigadores involucrados, gerentes y los resultados de cada proyecto. La creación de una web, con una rica interfaz que proporciona un fácil interacción con los usuarios del Sistema de Desarrollo de la Gestión. Simplificar el proceso de inscripción de nueva información, así como la extracción de informes detallados que pueden expresar de manera clara y objetiva los resultados de los esfuerzos de cada encuesta, entre los ingenieros e investigador, lo que refleja los resultados de los recursos para cada proyecto.</p>
